...
const azureSqlEvaluation: TechnologyEvaluation = {
  ...
  teamExpertise: 9,           // SQL universal skill
  complianceFeatures: 10,     // Always Encrypted, audit, TDE
  ecosystem: 9,               // Mature SQL ecosystem
  performance: 8,             // Excellent for OLTP
  scalability: 8,             // Read replicas, sharding
  maintainability: 10,        // Fully managed PaaS

  hipaaReady: true,
  baaAvailable: true,
  auditLogging: true,         // Built-in audit logging
  encryptionSupport: true,    // Always Encrypted, TDE, column-level

  fhirSupport: false,         // Not FHIR-native (use Aidbox)
  hl7Libraries: false,        // Relational, not document store
  healthcareExamples: [
    'Kaiser Permanente',
    'Partners HealthCare',
    'Mayo Clinic',
  ...
  monthlyCost: {
    small: 100,     // Basic tier
    medium: 500,    // Standard S3
    large: 2000,    // Premium P2 + replicas
  },

  overallScore: 9.0,
  recommendation: 'Primary',
  rationale: 'Best for transactional data (patient demographics, orders, billing), Always Encrypted for PHI, excellent audit logging, fully managed.',
};
```
